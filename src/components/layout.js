      ...
      <footer>
        <div className={"container"}>
            ...
            <div className={"col-3"}>
              <div className={"widget__item"}>
                <div className={"social"}>
                  ...
                  <a href="https://github.com/taggers-io" target={"_blank"} title={"GitHub"}><img alt={"GitHub"}
                                                                                                  src={iconGitHub} /></a>
          ...
          <div className={"copyright"}>
            <p>Copyright {new Date().getFullYear()}, {` `} <a href="https://taggers.io" title={"Taggers"}>Taggers</a>.
